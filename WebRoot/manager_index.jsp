...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="servlet/courseServlet?type=list" target="right"><span class="icon-caret-right"></span>课程信息管理</a></li>
    <li><a href="servlet/classServlet?type=list" target="right"><span class="icon-caret-right"></span>班级信息管理</a></li> 
    <li><a href="servlet/specialityServlet?type=list" target="right"><span class="icon-caret-right"></span>专业信息管理</a></li> 
