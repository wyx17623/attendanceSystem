...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="servlet/attendanceServlet?type=studentlistrecord" target="right"><span class="icon-caret-right"></span>个人考勤记录</a></li>
    <h2> <span class="icon-wrench"></span>个人信息管理</h2>
    <li><a href="servlet/studentServlet?type=personallist&stuID=<%=userid %>" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
  </ul> 
