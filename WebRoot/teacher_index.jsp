...
<div class="leftnav">
  ...
  <h2><span class="icon-user"></span>考勤管理</h2>
  <ul style="display:block">
    <li><a href="page/attendance/attendance_index.jsp" target="right"><span class="icon-caret-right"></span>在线点名</a></li>
    <li><a href="servlet/attendanceServlet?type=listrecord" target="right"><span class="icon-caret-right"></span>考勤记录</a></li>
    <li><a href="page/attendance/attendanceStatistics_index.jsp" target="right"><span class="icon-caret-right"></span>考勤情况统计</a></li>
