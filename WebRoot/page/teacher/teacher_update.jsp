...
<body>
<%
	List<listteacher> sl = (List<listteacher>)session.getAttribute("list"); 
    ...
    <form method="post" class="form-x" action="servlet/teacherServlet?type=update">  
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getResSec() %>" name="resSec" data-validate="required:数据必填项" />
          <div class="tips"></div>
        </div>
      </div>
