...
<body>
<%
	List<liststudent> sl = (List<liststudent>)session.getAttribute("list"); 
String index = request.getParameter("index");
liststudent tl = sl.get(Integer.parseInt(index));
...
<div class="panel admin-panel">
  <div class="body-content">
    <form method="post" class="form-x" action="servlet/studentServlet?type=persionalupdate">  
      <div class="form-group">
        <div class="label">
          <label>学生编号：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getStuID() %>" name="stuID" readonly="readonly"" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getStuName() %>" name="stuName"   />
          <div class="tips"></div>
        </div>
      </div>
     <div class="form-group">
    ...
    <div class="form-group">
      ...
      <%} %>
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getStuTel() %>" name="stuTel" data-validate="required:数据必填项" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getAddress() %>" name="address" data-validate="required:数据必填项" />
          <div class="tips"></div>
        </div>
      </div>
     <div class="form-group">
