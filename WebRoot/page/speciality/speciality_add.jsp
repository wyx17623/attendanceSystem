...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>增加专业</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="servlet/specialityServlet?type=add">  
      <div class="form-group">
        <div class="label">
          <label>专业编号：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="" name="speID"   />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="speName"   />
          <div class="tips"></div>
        </div>
      </div>     
           <div class="form-group">
