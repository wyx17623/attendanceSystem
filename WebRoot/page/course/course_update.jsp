...
<body>
<%  List<courselist> sl = (List<courselist>)session.getAttribute("list"); 
String index = request.getParameter("index");
courselist tl = sl.get(Integer.parseInt(index));
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="servlet/courseServlet?type=update">  
      <div class="form-group">
        <div class="label">
          <label>课程编号：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getCourseID() %>" name="courseID"   />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getCourseName() %>" name="courseName"   />
          <div class="tips"></div>
        </div>
      </div>
     <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getCredit() %>" name="credit"   />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <%} %>
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getPeriod() %>" name="period"   />
          <div class="tips"></div>
        </div>
      </div>
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getCourseTime() %>" name="courseTime" data-validate="required:数据必填项" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getCourseSite() %>" name="courseSite" data-validate="required:数据必填项" />
          <div class="tips"></div>
        </div>
      </div>
        <div class="form-group">
